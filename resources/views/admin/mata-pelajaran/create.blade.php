...
<div class="max-w-lg space-y-6">
    <div>
        <h2 class="text-2xl font-bold text-gray-800 dark:text-white">Tambah Mata Pelajaran</h2>
        <p class="text-sm text-gray-500 dark:text-gray-400">Tambahkan mata pelajaran untuk penilaian rapor</p>
    </div>

    <div class="rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900 shadow-theme-sm p-6">
        <form method="POST" action="{{ route('admin.mata-pelajaran.store') }}" class="space-y-5">
            @csrf
            <div>
