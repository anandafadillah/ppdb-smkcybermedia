...
@endphp
    ...
    <div class="mb-6 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h2 class="text-title-sm2 font-bold text-gray-800 dark:text-white/90">Dashboard Admin</h2>
            ...
            <div class="mt-5 flex items-end justify-between">
                ...
                <span class="inline-flex items-center gap-1 rounded-full bg-success-50 px-2 py-0.5 text-xs font-medium text-success-700 dark:bg-success-500/15 dark:text-success-500">
                    <svg width="12" height="12" fill="none" viewBox="0 0 12 12">
                        <path d="M6 2.5L9 7H3L6 2.5Z" fill="currentColor"/>
                    </svg>
                    {{ $persenVerif }}%
                </span>
            </div>
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
            ...
            <div class="mt-5 flex items-end justify-between">
                <div>
                    ...
                    <h4 class="mt-2 text-2xl font-bold text-gray-800 dark:text-white/90">
                        {{ number_format($kpi['daftar_ulang']) }}
                    </h4>
                </div>
    ...
    {{-- Distribusi Section: Per Jalur (chart-like) + Per Jurusan (demographic-like) --}}
    <div class="grid grid-cols-1 gap-4 lg:grid-cols-3 md:gap-6 mb-6">
        {{-- Per Jalur Pendaftaran (lebar 2 kolom) --}}
        <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6 lg:col-span-2">
            <div class="flex items-center justify-between mb-5">
                ...
                <a href="{{ route('admin.statistik.index') }}" class="text-xs font-medium text-brand-600 dark:text-brand-400 hover:underline">
                    Lihat detail →
                </a>
            </div>
    ...
    {{-- Status Verifikasi & Hasil (donut-style cards) --}}
           ...
           class="group rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] hover:border-brand-300 dark:hover:border-brand-700 hover:shadow-theme-md transition-all">
            <div class="flex items-center gap-4">
                <div class="flex h-11 w-11 items-center justify-center rounded-xl bg-brand-50 dark:bg-brand-500/10 text-brand-500 group-hover:bg-brand-500 group-hover:text-white transition-colors">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path fill-rule="evenodd" clip-rule="evenodd" d="M8 2C8.41 2 8.75 2.34 8.75 2.75V3.75H15.25V2.75C15.25 2.34 15.59 2 16 2C16.41 2 16.75 2.34 16.75 2.75V3.75H18.5C19.74 3.75 20.75 4.76 20.75 6V19C20.75 20.24 19.74 21.25 18.5 21.25H5.5C4.26 21.25 3.25 20.24 3.25 19V6C3.25 4.76 4.26 3.75 5.5 3.75H7.25V2.75C7.25 2.34 7.59 2 8 2Z" fill="currentColor"/></svg>
                </div>
                <div>
                    <p class="text-sm font-semibold text-gray-800 dark:text-white/90">Tahun Penerimaan</p>
                    <p class="text-xs text-gray-500 dark:text-gray-400">Kelola tahun aktif</p>
                </div>
            </div>
        </a>
        ...
        <a href="{{ route('admin.jurusan.index') }}"
           class="group rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] hover:border-success-300 dark:hover:border-success-700 hover:shadow-theme-md transition-all">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <p class="text-sm font-semibold text-gray-800 dark:text-white/90">Jurusan</p>
                    <p class="text-xs text-gray-500 dark:text-gray-400">Kelola jurusan</p>
                </div>
            </div>
        </a>

        <a href="{{ route('admin.jalur-pendaftaran.index') }}"
           class="group rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] hover:border-warning-300 dark:hover:border-warning-700 hover:shadow-theme-md transition-all">
            <div class="flex items-center gap-4">
                <div class="flex h-11 w-11 items-center justify-center rounded-xl bg-warning-50 dark:bg-warning-500/10 text-warning-600 group-hover:bg-warning-500 group-hover:text-white transition-colors">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path fill-rule="evenodd" clip-rule="evenodd" d="M8.5 4.25H15.28L18.5 7.47V16.75C18.5 17.16 18.16 17.5 17.75 17.5H9.25C8.84 17.5 8.5 17.16 8.5 16.75V4.25Z" fill="currentColor"/></svg>
                </div>
                <div>
                    <p class="text-sm font-semibold text-gray-800 dark:text-white/90">Jalur Pendaftaran</p>
                    <p class="text-xs text-gray-500 dark:text-gray-400">Kelola jalur & kuota</p>
                </div>
            </div>
        </a>
    </div>

    {{-- Pengumuman Terbaru (table-style) --}}
