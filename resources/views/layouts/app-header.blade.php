<header id="header" class="sticky top-0 flex w-full bg-white border-gray-200 z-99999 dark:border-gray-800 dark:bg-gray-900 xl:border-b">
    <div class="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        <div class="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-gray-200 dark:border-gray-800 sm:gap-4 xl:justify-normal xl:border-b-0 xl:px-0 lg:py-4">
            ...
            {{-- App Name (mobile) --}}
            <a href="/" class="xl:hidden font-bold text-gray-800 dark:text-white">
                PPDB Cyber Media
            </a>
        </div>

        {{-- Right actions --}}
        <div class="flex items-center justify-end w-full gap-4 px-5 py-4 xl:flex shadow-theme-md xl:justify-end xl:px-0 xl:shadow-none">
            {{-- Theme Toggle --}}
            <button
