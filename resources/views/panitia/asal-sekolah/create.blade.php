...
<div class="max-w-2xl space-y-6">
    ...
    <div class="rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900 shadow-theme-sm p-6">
        <form method="POST" action="{{ route('panitia.asal-sekolah.store') }}" class="space-y-5">
            @csrf
    ...
    <div class="rounded-xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900 shadow-theme-sm p-6">
        ...
        <p class="text-sm text-gray-500 dark:text-gray-400 mb-4">
            Kolom wajib: <code class="bg-gray-100 dark:bg-gray-800 px-1 rounded">NPSN</code>,
        ...
        <form method="POST" action="{{ route('panitia.asal-sekolah.import') }}" enctype="multipart/form-data" class="flex items-center gap-3">
            @csrf
