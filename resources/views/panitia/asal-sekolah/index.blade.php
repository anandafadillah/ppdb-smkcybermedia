...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        ...
        <a href="{{ route('panitia.asal-sekolah.create') }}"
    ...
    {{-- Search --}}
    <form method="GET" action="{{ route('panitia.asal-sekolah.index') }}" class="flex gap-3">
                ...
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50">
                    ...
                    <td class="px-5 py-4">
                        <div class="flex items-center gap-3">
                            <a href="{{ route('panitia.asal-sekolah.edit', $sekolah) }}"
                                class="text-brand-600 hover:text-brand-700 dark:text-brand-400 text-sm font-medium">
                                Edit
                            </a>
                            <form method="POST" action="{{ route('panitia.asal-sekolah.destroy', $sekolah) }}"
