...
class AsalSekolahController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('panitia.asal-sekolah.index', compact('asalSekolah'));
    }

    public function create()
    {
        return view('panitia.asal-sekolah.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/panitia/asal-sekolah')->with('success', 'Asal sekolah berhasil ditambahkan.');
    }

    public function edit(AsalSekolah $asalSekolah)
    {
        return view('panitia.asal-sekolah.edit', compact('asalSekolah'));
    }
    ...
    public function update(Request $request, AsalSekolah $asalSekolah)
    {
        ...
        return redirect('/panitia/asal-sekolah')->with('success', 'Asal sekolah berhasil diperbarui.');
    }
    ...
    public function destroy(AsalSekolah $asalSekolah)
    {
        ...
        return redirect('/panitia/asal-sekolah')->with('success', 'Asal sekolah berhasil dihapus.');
    }
    ...
    public function import(Request $request)
    {
        ...
        (new FastExcel)->import($path, function ($line) use (&$errors, &$imported) {
            ...
            if (!$npsn || !$nama || !$status) {
                $errors[] = "NPSN '$npsn': field wajib kosong.";
                return null;
            }
            ...
            try {
                AsalSekolah::updateOrCreate(
                    ['npsn' => $npsn],
                    ['nama' => $nama, 'alamat' => $line['Alamat'] ?? null,
                     'kelurahan' => $line['Kelurahan'] ?? null,
                     'kecamatan' => $line['Kecamatan'] ?? null, 'status' => $status]
                );
                $imported++;
            } catch (\Exception $e) {
        ...
        if ($errors) {
            ...
            return redirect('/panitia/asal-sekolah')->with('warning', $msg)->with('import_errors', $errors);
        }

        return redirect('/panitia/asal-sekolah')->with('success', $msg);
    }
}
